...
global.dfail = (type, m, conn) => {
  ...
  if (unreg) return conn.sendButton(m.chat, `╭─֍〔 ⚠️𝐔𝐍𝐑𝐄𝐆𝐈𝐒𝐓𝐄𝐑⚠️ 〕֍─\n⬡ Halo @user :)\n⬡ Harap Verify terlebih dahulu ya kak ><\n⬡ button tak merespon? pakai cara dibawah\n╰─────────────────֍\n╭─֍〔 CONTOH 〕֍─/n⬡ #daftar namamu.umurmu\n⬡ #daftar siska.16\n╰────────֍ `, watermark, 'Verify', `#daftar ${name}.17`, { key: { fromMe: false, remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { message: `©shirobotz_\nJam ${time}`, itemCount: 2022, thumbnail: fs.readFileSync('./src/RadBotZ.jpg')}}})
}
